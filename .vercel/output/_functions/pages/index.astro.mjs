/* empty css                                     */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, e as createAstro, f as renderComponent } from '../chunks/astro/server_BiZfhCPB.mjs';
import 'kleur/colors';
import { $ as $$Layout } from '../chunks/layout_box0wcPt.mjs';
  ...
  const handleAddPromotion = async (e) => {
    ...
    try {
      ...
      if (image) {
        ...
        imageUrl = `${define_process_env_default.PUBLIC_SUPABASE_URL}/storage/v1/object/public/promotion images/${uploadData?.path}`;
      }
...
const PromotionList = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "flex relative w-full overflow-hidden my-12", children: /* @__PURE__ */ jsx(
    "div",
    {
      className: "w-full flex gap-20 md:gap-32 lg:gap-40 animate-loop-scroll",
      children: promotions.map((promotion) => /* @__PURE__ */ jsxs(
        "div",
        {
