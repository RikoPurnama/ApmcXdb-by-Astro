/* empty css                                     */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, e as createAstro, f as renderComponent } from '../chunks/astro/server_Cn0lcgAD.mjs';
import 'kleur/colors';
  ...
  const handleAddPromotion = async (e) => {
    ...
    try {
      ...
      if (image) {
        ...
        if (!result2) throw new Error("Gagal memproses gambar.");
        imageBase64 = {
          name: image.name,
          type: image.type,
          data: result2.split(",")[1]
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "Title": "Homepage" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Nav", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "E:/projects/Astrojs projects/ApmcProjects/src/components/react/nav", "client:component-export": "default" })} ${renderComponent($$result2, "Intro", Intro, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "E:/projects/Astrojs projects/ApmcProjects/src/components/react/intro", "client:component-export": "default" })} ${renderComponent($$result2, "Banner", About, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "E:/projects/Astrojs projects/ApmcProjects/src/components/react/banner", "client:component-export": "default" })} ${renderComponent($$result2, "AboutProduct", $$AboutProduct, {})} ${renderComponent($$result2, "Product", Product, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "E:/projects/Astrojs projects/ApmcProjects/src/components/react/productPrices", "client:component-export": "default" })} ${renderComponent($$result2, "VoucherProduct", $$VoucherProduct, {})} ${renderComponent($$result2, "MitraVoucher", mitraVoucher, { "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/projects/Astrojs projects/ApmcProjects/src/components/mitraVoucher", "client:component-export": "default" })} ${renderComponent($$result2, "Location", LocationAndService, { "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/projects/Astrojs projects/ApmcProjects/src/components/react/locationAndService", "client:component-export": "default" })} ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
